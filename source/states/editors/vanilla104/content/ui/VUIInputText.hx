package states.editors.vanilla104.content.ui;
...
class VUIInputText extends FlxSpriteGroup
{
	...
	public static var focusOn(default, set):VUIInputText = null;
		...
		if(e.controlKey)
		{
			switch(flxKey)
			{
				...
				case V: //paste from clipboard
					...
					if(broadcastInputTextEvent) VUIEventHandler.event(CHANGE_EVENT, this);
	...
	public static function set_focusOn(v:VUIInputText)
	{
